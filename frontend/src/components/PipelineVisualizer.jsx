            ...
            <React.Fragment key={stage.id}>
              ...
              <div className="flex flex-col items-center shrink-0 w-20 sm:w-24 group">
                ...
                <div className="relative w-14 h-14 sm:w-16 sm:h-16 mb-4 flex items-center justify-center
                                bg-gradient-to-br from-white/[0.08] to-transparent border border-white/[0.1]
                                rounded-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] 
                                transition-all duration-500 hover:scale-110 hover:border-white/[0.2] hover:bg-white/[0.1]">
                  {/* Subtle top glare */}
                  <div className="absolute inset-x-0 top-0 h-1/2 bg-gradient-to-b from-white/[0.05] to-transparent rounded-t-xl" />
                  <Icon className={`w-5 h-5 sm:w-6 sm:h-6 relative z-10 transition-colors duration-300 ${stage.color} group-hover:text-white`} strokeWidth={2} />
                </div>
                {/* Label */}
