      ...
      <div className="min-h-screen text-white flex relative overflow-hidden bg-[#000000]">
        ...
        <aside className="w-56 shrink-0 glass-sidebar hidden md:flex flex-col min-h-screen z-20">
          ...
          <div className="p-4 border-t border-white/[0.06]">
            <button className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/80 hover:text-white transition-colors">
            ...
            <div className="flex items-center gap-3">
              {s.step === 'results' && s.result && (
                <span className="text-xs text-white/80 mr-2">
                  {s.isDemo && <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-white/[0.06] text-white/90 border border-white/[0.08] mr-2">Demo</span>}
                </span>
              )}
              ...
              <div className="w-8 h-8 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-xs font-bold text-white overflow-hidden">
