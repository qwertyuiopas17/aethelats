...
@app.cls(
    ...
    scaledown_window=600,      # keep warm for 10 min after last request, then shut down
    # min_containers removed — was keeping GPU running 24/7 and burning credits.
    # Container now spins up on first request (~60-90s cold start) and shuts
    # down automatically after 10 min idle. Truly serverless.
    secrets=[modal.Secret.from_name("hf-secret")],
)
class Bot3Structurer:
    ...
    def _build_prompt(self, sanitized_text: str) -> str:
        ...
        return (
            ...
            "education, experience, work_experience_summary. No markdown, no explanation.\n\n"
            ...
            "- If the resume says \"B.Tech\" or \"Bachelor of Technology\", output \"Bachelor\"<|im_end|>\n"
            "<|im_start|>user\nParse this resume:\n\n"
